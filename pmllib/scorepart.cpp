...
*The notes are held as a list of SNotes in the list 'm_notes'
**/
...
PerfPart *ScorePart::getPerfPart(){
    ...
    //this matches up the ID of the Scorepart with the Performance Part.  
    //If a performance exists it returns the performance information
